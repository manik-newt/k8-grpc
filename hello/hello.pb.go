...
func (x *HelloFrequency) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HelloFrequency) ProtoMessage() {}

func (x *HelloFrequency) ProtoReflect() protoreflect.Message {
	mi := &file_hello_hello_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HelloFrequency.ProtoReflect.Descriptor instead.
func (*HelloFrequency) Descriptor() ([]byte, []int) {
	return file_hello_hello_proto_rawDescGZIP(), []int{1}
}

func (x *HelloFrequency) GetClientId() string {
	if x != nil {
		return x.ClientId
	}
	return ""
...
func (x *HelloFrequency) GetFrequency() uint32 {
	if x != nil {
		return x.Frequency
	}
	return 0
...
var file_hello_hello_proto_rawDesc = []byte{
	...
	0x0a, 0x0e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x46, 0x72, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x79,
	...
	0x52, 0x09, 0x66, 0x72, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x79, 0x22, 0x26, 0x0a, 0x0a, 0x48,
	0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x32, 0x7d, 0x0a, 0x07, 0x47, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72, 0x12, 0x34,
	...
	0x6c, 0x79, 0x22, 0x00, 0x12, 0x3c, 0x0a, 0x0c, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x4e, 0x6f,
	0x74, 0x69, 0x66, 0x79, 0x12, 0x15, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x48, 0x65, 0x6c,
	0x6c, 0x6f, 0x46, 0x72, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x79, 0x1a, 0x11, 0x2e, 0x68, 0x65,
	...
	0x2f, 0x6d, 0x61, 0x6e, 0x69, 0x6b, 0x6e, 0x75, 0x74, 0x61, 0x6e, 0x69, 0x78, 0x2f, 0x6b, 0x38,
	0x2d, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x3b, 0x68, 0x65, 0x6c, 0x6c,
...
var file_hello_hello_proto_goTypes = []interface{}{
	...
	(*HelloFrequency)(nil), // 1: hello.HelloFrequency
...
var file_hello_hello_proto_depIdxs = []int32{
	...
	1, // 1: hello.Greeter.ClientNotify:input_type -> hello.HelloFrequency
	2, // 2: hello.Greeter.SayHello:output_type -> hello.HelloReply
	2, // 3: hello.Greeter.ClientNotify:output_type -> hello.HelloReply
